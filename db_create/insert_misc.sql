...
values
('Phone Number', 'The shop\'s phone number', '(928) 773-1862');

insert into single_track.misc_text
values
('Address', 'The shop\'s address', '575 Riordan Rd  Flagstaff, AZ 86001');

insert into single_track.misc_text
values
('Hours', 'The shop\'s hours of operation', 'M-F 9:00 AM - 6:00 PM<br/>Sat. 10:00 AM - 5:00 PM<br/>Sun. 10:00 AM - 4:00 PM');

insert into single_track.misc_text
values
('Location Text', 'The text that will be displayed on the Location and Contact Page', 'Located just off of Milton Road in Flagstaff');
